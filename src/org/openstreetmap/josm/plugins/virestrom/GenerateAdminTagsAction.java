...
public class GenerateAdminTagsAction extends JosmAction {
    ...
    private static String lastTownship = "";
    ...
    public GenerateAdminTagsAction() {
        super(
            ...
            Shortcut.registerShortcut("virestrom:admin", "Create Admin Tags", KeyEvent.VK_I, Shortcut.CTRL_SHIFT),
            false
        );
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        JTextField townshipField = new JTextField(lastTownship, 20);
        ...
        panel.add(new JLabel("is_in:township:")); panel.add(townshipField);
        ...
        try {
            ...
            if (!lastTownship.isEmpty()) newRelation.put("is_in:township", lastTownship);
